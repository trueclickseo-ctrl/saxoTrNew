...
logger = get_logger("saxo_auth_auto")
...
class CallbackHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        logger.info("Received authorization code from Saxo redirect")
...
def login_auto():
    ...
    logger.info("Starting automatic PKCE login flow")
    ...
    # Success!
    logger.info("Automatic login flow completed successfully")
    print("  " + "=" * 54)
...
def refresh_existing():
    ...
    try:
        logger.info("Attempting to refresh existing token...")
        ...
        logger.info("Token refreshed successfully! No login needed.")

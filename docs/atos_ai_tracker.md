...
- Run `python report_phase_b_counterfactual.py sim` — **the key gate**: if net EUR effect is positive with ≥10 matched trades, that's the flip signal. First run 2026-09-06: +264.6 EUR on 55 trades — POSITIVE. Re-run 2026-09-13 with more data.
...
2. **Phase B counterfactual** — first run +264.6 EUR (POSITIVE). Re-run 2026-09-13: `python report_phase_b_counterfactual.py sim`.

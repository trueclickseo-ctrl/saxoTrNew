...
2. **Exposure controller data** — 1 block logged so far. After 1 week (~2026-09-13): `python report_exposure_controller.py sim --tighten` to decide if limits tighten before Phase B.
3. **Clean give-back data (P2)** — `python report_giveback.py`. When ≥10–15 clean trades/strategy, drives exit-improvement / SuperTrend-V2 decision.

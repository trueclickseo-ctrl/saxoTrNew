...
# Exit filter: require 2nd consecutive close beyond hard_stop before confirming exit, unless breach is severe (>0.3*ATR) -- unchanged, sample too small (n=4) for new rule
